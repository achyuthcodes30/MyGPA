  ...
  const onCalc: SubmitHandler<Fields> = data => {
    ...
    const hasDuplicates = data.courses.some((course, index) => {
      ...
      if (lowerCaseTitle && titlesSet.has(lowerCaseTitle)) {
        ...
        toast.error(
          `Course '${title}' was entered multiple times. Please change before submitting.`,
          {
          ...
          <div ref={courseTitles} className="mb-4 max-w-[30%] ">
            ...
            <span ref={courseRef} className="flex flex-row items-center">
              ...
              <input
                ...
                className={`h-8 w-4/5 lg:h-10 lg:w-full ${spectral.className} relative mb-3 mt-4 rounded-xl text-center lg:my-6`}
              />
            </span>
            ...
            {fields.slice(1, courseNumber).map((semester, index: number) => (
              <span key={index} className="flex flex-row justify-center">
                ...
                <input
                  ...
                  className={`relative h-8 w-4/5 lg:h-10 lg:w-full ${spectral.className} -mt-[0.2rem] rounded-xl text-center lg:mt-0`}
                />
              </span>
            ))}
            <div
            ...
            >
              <div
                className="calcbutton mx-auto flex w-[95%] justify-center rounded-full bg-gradient-to-br from-purple-800 to-pink-500 shadow-2xl lg:w-[85%]"

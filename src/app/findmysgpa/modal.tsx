    ...
    case floatgpa > 9:
      message = (
        <>
          ...
          <p
            className={`text-center text-lg text-white ${spectral.className} mx-auto `}
          >
      ...
      message = (
        <>
          <p
            className={` text-lg text-white ${spectral.className} text-center  `}
          >
            Impressive! Your academic progress is noteworthy, and there is
            potential for excellence in future endeavors.
          </p>
        </>
      );
      break;
      ...
      message = (
        <>
          <p
            className={` text-lg text-white ${spectral.className} text-center  `}
          >
            Amid challenges, your dedication stands strong. Each hurdle is a
            stepping stone to your future success. Keep going!
          </p>
        </>
      );
  }
        ...
        {isOpen && (
          <>
            ...
            w-2/3 justify-center rounded-3xl
              bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-indigo-800 via-indigo-700 to-violet-700"
            >
              <h1
